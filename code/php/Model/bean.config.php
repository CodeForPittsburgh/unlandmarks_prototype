 ...
 * $dbconn = pg_connect('host=' . DBHOST . ' port=' . DBPORT . ' dbname=' . DBNAME . ' user=' . DBUSER . ' password=' . DBPASSWORD. ' connect_timeout=' . DBTIMEOUT);
 */

define("DBHOST","localhost");
define("DBUSER","postgres");
define("DBPASSWORD","win95sux");
define("DBNAME","postgres");
define('DBPORT', '5432');
define('DBTIMEOUT',300);
$conn = pg_connect('host=' . DBHOST . ' port=' . DBPORT . ' dbname=' . DBNAME . ' user=' . DBUSER . ' password=' . DBPASSWORD. ' connect_timeout=' . DBTIMEOUT);
define('DBCONN',$conn);


    function addSingleQuote($str) {
        return "'" . $str . "'";
    }
/**
 * Date formats:
