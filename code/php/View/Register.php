...
<!--        <div class="container body-content">
    ...
    <div class="form-horizontal">
        ...
        <div class="form-group">
            <label for="MainContent_UserName" class="col-sm-2 control-label">User name</label>
            <div class="col-sm-10">
        ...
        <div class="form-group">
            <label for="MainContent_Password" class="col-sm-2 control-label">Password</label>
            <div class="col-sm-10">
        ...
        <div class="form-group">
            <label for="MainContent_ConfirmPassword" class="col-sm-2 control-label">Confirm password</label>
            <div class="col-sm-10">
